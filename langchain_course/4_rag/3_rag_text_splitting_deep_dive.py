"""
This example demonstrates different text splitting techniques for RAG (Retrieval Augmented Generation)
applications using LangChain. 
It includes character-based, sentence-based, token-based, and recursive character-based splitting methods, 
along with vector store creation and querying capabilities.
"""
...
from custom_splitter.custom_text_splitter import CustomTextSplitter
...
input_query = "How did Juliet die?"

# Query each vector store
# query_vector_store("chroma_db_char", input_query)
# query_vector_store("chroma_db_sent", input_query)
# query_vector_store("chroma_db_token", input_query)
# query_vector_store("chroma_db_rec_char", input_query)
query_vector_store("chroma_db_custom", input_query)
